const stateShowUserMenuView = (obj) => {
    debug(`stateShowUserMenuView()`)
    return `
        ...
        <li>
            ...
            <div class="uk-navbar-dropdown uk-navbar-dropdown-bottom-right" style="left: 674px; top: 80px;">
                <ul class="uk-nav uk-navbar-dropdown-nav">
                    ...
                    <li><a id="dashboards"><span data-uk-icon="icon: thumbnails" class="uk-icon"></span> Dashboards</a></li>
                    <li><a id="payments"><span data-uk-icon="icon: credit-card" class="uk-icon"></span> Payments</a></li>
                    <li><a id="configuration"><span data-uk-icon="icon: cog" class="uk-icon"></span> Configuration</a></li>
                    <li class="uk-nav-divider"></li>
                    <li><a id="your-data"><span data-uk-icon="icon: database" class="uk-icon"></span> Your Data</a></li>
                    <li class="uk-nav-divider"></li>
                    <li><a id="logout"><span data-uk-icon="icon: sign-out" class="uk-icon"></span> Logout</a></li>
                </ul>
            </div>
        </li>
    </ul>
