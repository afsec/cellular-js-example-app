const stateShowUsersPageShowFiltersPresenter = async (message) => {
    debug(`stateShowUsersPageShowFiltersPresenter()`)
    const model = await stateShowUsersPageShowFiltersModel(message)
    ...
    const applyFilters = async (obj) => {
        ...
        stateShowUsersPageContent(currentState, filteredData)
    }
